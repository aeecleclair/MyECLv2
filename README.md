...
- **multer_method** : permet de choisir la methode utilisé par multer (**multer_method.name** : 'single' (par défaut) ou 'fields' ou 'array') et de spécifier les options nécessaires (**multer_method.options** cf [https://github.com/expressjs/multer#api|l'API multer]) (par défaut 'file')
