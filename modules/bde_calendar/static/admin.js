$("#calendar").fullCalendar({
    ...
    height:200,
    events:'/modules/bde_calendar/get_all',
    eventClick: function(calEvent, jsEvent, view) {
        ...
        html += "<form class='form-horizontal' action='/modules/bde_calendar/delete' method='post'>";
        html += "<div class='form-group'>";
        html += "<div class='col-sm-4 col-sm-offset-4'>";
        html += "<input type='hidden' name='id' value='" + calEvent.id + "' />";
        html += "<button class='btn btn-danger btn-block' type='submit'>Supprimer</button>";
        html += "</div>";
        html += "</div>";
        html += "</form>";
