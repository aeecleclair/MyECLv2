module.exports = function(context){
    ...
    function check_authorisation(user, module_auth, callback){
        // Compare les autorisations de user à module_auth et renvoie true si l'utilisateur peux acceder aux ressources
    ...
    return function (module_auth){
        ...
        // renvoie un middleware qui test si l'utilisateur peut accéder à une ressource
        var middleware;
